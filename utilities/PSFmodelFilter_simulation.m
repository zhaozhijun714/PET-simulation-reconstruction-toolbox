function image_filter = PSFmodelFilter_simulation(image_in, image_size, voxel_size, FWHM)
image_in = reshape(image_in, image_size);
if size(image_in, 3)>1
    vox3dsz = voxel_size;
else
    vox3dsz = voxel_size(1:2);
end
